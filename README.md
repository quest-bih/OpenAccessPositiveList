...
There is also a R-Shiny App included in the 'OAPositive_List_shiny' folder to display the resulting table in an easily searchable and filterable way in the browser. An online version of the original list can be found on https://s-quest.bihealth.org/OAPositiveList/.
